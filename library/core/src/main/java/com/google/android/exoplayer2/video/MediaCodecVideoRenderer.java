...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    private static final String TAG = "Kiran-MediaCodecVideoRe";
    ...
    public void handleMessage(int messageType, Object message) throws ExoPlaybackException {
        ...
        } else if (messageType == C.MSG_SET_SCALING_MODE_CHANGE) {
            //mosaicChange(1);
            Log.v(TAG, "MSG_SET_SCALING_MODE_CHANGE");
           /* mosaicToggle = 1;
            for (int i = 10; i < 10; i++) {
...
*/
  ...
  //kiran mosaic
  private void mosaicChange(){

//    eventDispatcher.videoSizeChanged(3, 1, 0,
//            (float)0.2 );
//
...
//    reportedPixelWidthHeightRatio = currentPixelWidthHeightRatio;
    ...
    return;
    /*if(toggle == 1){
      eventDispatcher.videoSizeChanged(4, 1, 0,
              (float)1.0 );
    ...
    private void maybeNotifyVideoSizeChanged() {
        ...
        if (((currentWidth != Format.NO_VALUE || currentHeight != Format.NO_VALUE)
                ...
                || reportedUnappliedRotationDegrees != currentUnappliedRotationDegrees
                || reportedPixelWidthHeightRatio != currentPixelWidthHeightRatio)) /*|| mosaicToggle == 1*/) {
            Log.v(TAG, "maybeNotifyVideoSizeChanged");
            /*mosaicToggle = 0;*/
            eventDispatcher.videoSizeChanged(currentWidth, currentHeight, currentUnappliedRotationDegrees,
                    currentPixelWidthHeightRatio);
            reportedWidth = currentWidth;
